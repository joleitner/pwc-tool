...
ALTER TABLE "public"."comparison_pairs" OWNER TO "postgres";
...
ALTER TABLE "public"."comparison_pairs" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."pair_comparisons_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."comparison_pairs"
    ADD CONSTRAINT "pair_comparisons_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."comparison_pairs"
    ADD CONSTRAINT "pair_comparisons_image_1_fkey" FOREIGN KEY ("image_1") REFERENCES "public"."images"("id");



ALTER TABLE ONLY "public"."comparison_pairs"
    ADD CONSTRAINT "pair_comparisons_image_2_fkey" FOREIGN KEY ("image_2") REFERENCES "public"."images"("id");



ALTER TABLE ONLY "public"."comparison_pairs"
    ADD CONSTRAINT "pair_comparisons_survey_fkey" FOREIGN KEY ("survey") REFERENCES "public"."surveys"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."pwc_results"
    ADD CONSTRAINT "pwc_results_pair_fkey" FOREIGN KEY ("pair") REFERENCES "public"."comparison_pairs"("id") ON DELETE CASCADE;
...
CREATE POLICY "Create Survey for Admins" ON "public"."surveys" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."admin" = true)))));



CREATE POLICY "Delete for Admins" ON "public"."registrations" FOR DELETE USING ("public"."is_admin"());



CREATE POLICY "Enable insert for users based on user_id" ON "public"."registrations" FOR INSERT WITH CHECK (true);



CREATE POLICY "Enable read access for all authenticated users" ON "public"."comparison_pairs" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Insert for Admins" ON "public"."comparison_pairs" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."admin" = true)))));



CREATE POLICY "Insert for Admins" ON "public"."images" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."admin" = true)))));



CREATE POLICY "Insert for admins" ON "public"."participations" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."admin" = true)))));



CREATE POLICY "Insert for admins" ON "public"."users" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."users" "users_1"
  WHERE (("users_1"."id" = "auth"."uid"()) AND ("users_1"."admin" = true)))));
...
CREATE POLICY "Select for admin and own entry" ON "public"."pwc_results" FOR SELECT TO "authenticated" USING (("public"."is_admin"() OR ("user" = "auth"."uid"())));



CREATE POLICY "Select for admins" ON "public"."registrations" FOR SELECT TO "authenticated" USING (("public"."is_admin"() OR ("id" = "auth"."uid"())));
...
CREATE POLICY "Update for authenticated users" ON "public"."registrations" FOR UPDATE TO "authenticated" USING (("public"."is_admin"() OR ("id" = "auth"."uid"())));
...
GRANT ALL ON TABLE "public"."comparison_pairs" TO "anon";
GRANT ALL ON TABLE "public"."comparison_pairs" TO "authenticated";
GRANT ALL ON TABLE "public"."comparison_pairs" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."pair_comparisons_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."pair_comparisons_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."pair_comparisons_id_seq" TO "service_role";
